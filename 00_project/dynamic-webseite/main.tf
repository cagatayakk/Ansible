...
resource "null_resource" "config" {
  ...
  provisioner "file" {
    source = "./project/inventory_aws_ec2.yaml"
    destination = "/home/ec2-user/project/inventory_aws_ec2.yaml"
  }

  provisioner "file" {
    source = "./project/playbook.yaml"
    destination = "/home/ec2-user/project/playbook.yaml"
  }

  provisioner "file" {
    source = "./project/.my.cnf"
    destination = "/home/ec2-user/project/.my.cnf"
  }

  provisioner "file" {
    source = "./project/db-load-script.sql"
    destination = "/home/ec2-user/project/db-load-script.sql"
  }
